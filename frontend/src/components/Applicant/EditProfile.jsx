...
const EditProfile = () => {
  ...
  return ( 
    <div className="min-h-screen bg-gradient-to-r from-indigo-900 to-purple-900 flex items-center justify-center p-4">
      <div className="bg-white max-w-2xl w-full p-6 sm:p-8 rounded-lg shadow-lg relative">

        <h2 className="text-3xl font-bold mb-6 sm:mb-8 text-center">Edit Profile</h2>

        {message && (
          <div className="mb-4 text-center text-sm sm:text-base text-green-600">
            {message}
          </div>
        )}

        {errorMessage && (
          <div className="mb-4 text-center text-sm sm:text-base text-red-600">
            {errorMessage}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm
              focus:ring-indigo-500 focus:border-indigo-500
              file:border-0 file:px-4 file:py-2 file:bg-indigo-600 file:text-white
              file:rounded-xl file:cursor-pointer file:hover:bg-indigo-800"
            />
          </div>

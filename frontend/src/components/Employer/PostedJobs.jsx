              ...
              >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-indigo-600 break-words">
                      {job.title}
                    </h3>

                    <p className="mt-2 text-gray-700 text-sm break-words">
      ...
      {selectedJob && (
        <div className="fixed inset-0 backdrop-blur-xs bg-opacity-40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative max-h-[90vh] overflow-y-auto scroll-smooth">
            ...
            <p className="mb-2 break-words">Title: {selectedJob.title}</p>
            <p className="mb-2 break-words">Job Identification: {selectedJob.jobId}</p>
            <p className="mb-2 break-words">Company: {selectedJob.company}</p>
            <p className="mb-2 break-words">Location: {selectedJob.location}</p>
            <p className="mb-2 break-words">Job Type: {selectedJob.jobType}</p>

            <p className="text-center font-bold text-lg">Job Description</p>
            <p className="text-gray-800 whitespace-pre-wrap mb-4 break-words">

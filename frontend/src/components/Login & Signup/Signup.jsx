    ...
    <>
      {message && (
        <div className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50">
          <div
            // Ensure the message box doesn't get too wide on small screens, 
            // and has full responsiveness up to max-w-sm or max-w-md
            className={`px-6 py-4 rounded shadow-lg text-center max-w-sm w-[90vw] sm:max-w-md ${
                messageType === "success"
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-r from-indigo-900 to-purple-900">
          {/* max-w-md is already good. Added mb-5 and mt-5 for edge case scroll bounce */}
          <div className="bg-white rounded-2xl p-8 shadow-md w-full max-w-md mt-5 mb-5">
              ...
              {/* Role buttons are already responsive due to flex and space-x-4 */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  {/* All input fields are w-full and responsive */}
                  <input
                      type="text"
                      name="name"
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:space-x-3 w-full space-y-2 sm:space-y-0">
                    <input
                      type="email"
                      name="email"
                      placeholder="Email"
                      ...
                      onChange={handleChange}
                      className="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 w-full"
                      required
                    />
                    <button
                      onClick={handleSendOtp}
                      disabled={isSending}
                      className="w-full sm:w-auto shrink-0 bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 text-sm"
                    >
                  ...
                  {/* Password field is already responsive */}

...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-900 to-purple-900 px-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md sm:max-w-lg md:max-w-md lg:max-w-sm">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-800 transition text-sm sm:text-base disabled:opacity-50"
          >

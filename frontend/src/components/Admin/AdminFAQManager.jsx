    ...
    <>
      ...
      {message && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-md">
          <div
            className={`px-6 py-4 rounded shadow-lg text-center w-full ${
              messageType === "success"
      ...
      {loading ? (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-900 to-purple-900 px-4">
          <div className="w-full max-w-3xl mx-auto mt-10 mb-10 p-6 bg-white rounded-2xl shadow">
            ...
            <div className="mb-6">
              ...
              <button
                onClick={addFAQ}
                className="bg-indigo-600 text-white px-5 py-2 rounded-md hover:bg-indigo-700 transition w-full sm:w-auto"
              >
                Add FAQ
              </button>
            </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        ...
                        <button
                          ...
                          className="bg-gray-300 px-4 py-1 rounded-md hover:bg-gray-500"
                        >
                          Cancel
                        </button>
                      </div>
